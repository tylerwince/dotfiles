" This checks to see if minpac exists, if it doesn't, it will install
" it to the opt directory
let minpac_exists=expand('~/.config/nvim/pack/minpac/opt/minpac/README.md')
...
if !filereadable(minpac_exists)
  ...
  echo ""
  silent !\mkdir -p ~/.config/nvim/pack/minpac/opt/minpac
...
" c
call minpac#add('vim-scripts/c.vim', {'for': ['c', 'cpp']})
